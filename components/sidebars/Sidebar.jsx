...
const Sidebar = () => {
  ...
  return (
    <Container>
      <div className="main _auto_scroll_y _flex_col_center _gap20">
        <div className="_grid_center" style={{ paddingTop: 20 }}>
          {LOGOSVG}
        </div>

        <div className="_flex_col_jcsb" style={{ gap: "17vh" }}>
          <div className="sidebar_links _flex_col_center _gap16">
            {LINK_LIST.map((item, i) => (
              <div
                key={i}
                onClick={item?.handleClick}
                className={`linkWrapper _flex_center _align_center _gap10 _pointer ${
                  i == 0 ? "active" : ""
                }`}
              >
                {item?.icon}
            ...
            <div className="_flex_center">
              <div
                className="toggleMode _flex_col_jcsb _align_center"
                style={{
                  padding: 8,
                  width: 46,
                  height: 92,
              ...
              >
                {modeIcons.map((icon) => icon)}
              </div>
            </div>
          </div>

          <div
            className="sidebar_links _flex_col_center _gap16"
            style={{ paddingBottom: 20 }}
          >
            {LINK_LIST2.map((item, i) => (
              <div
                key={i}
                onClick={item?.handleClick}
                className={`linkWrapper _flex_col _align_center _gap10 ${
                  // !i == 0 ? "active" :
                  ""
                }`}
              >
